...
**Business Analysis & PM Tools**

![JIRA](https://img.shields.io/badge/JIRA-0052CC?style=for-the-badge&logo=jira&logoColor=white)
![Agile](https://img.shields.io/badge/Agile%2FScrum-009639?style=for-the-badge)
...
### 🔹 [Lung Cancer Detection](LINK-TO-REPO)
Classification model for early lung cancer risk detection using patient health data, with a focus on model interpretability for healthcare stakeholders.

### 🔹 [SoccerSync](LINK-TO-REPO)
*(Add a one-line description of what this project does and the problem it solves.)*
